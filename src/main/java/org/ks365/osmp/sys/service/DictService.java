...
public class DictService {
    ...
    public Page<DictEntity> getListByColumn(DictEntity dictEntity) {
    ...
    public DictEntity getOneByColumn(DictEntity dictEntity) {
    ...
    public List<DictEntity> findListByType(String type) {
